...
function IdealMatchComponent() {
  ...
                    className={`relative bg-gradient-to-b ${match.color1} ${match.color2} rounded-2xl p-5 h-44 w-44 cursor-pointer transition-all duration-300 ${
                      selectedMatch === match.value ? "scale-105 shadow-lg" : "opacity-90"
                    }`}
                  >
